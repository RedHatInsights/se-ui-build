 ...
 * @export
 */
export declare const ErrorCatalogApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    getErrors: (page?: number | undefined, size?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * ErrorCatalogApi - functional programming interface
 * @export
 */
export declare const ErrorCatalogApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Get an error from the error catalog.
     * @summary Get an error from the error catalog.
     * @param {number} id
     ...
     * @throws {RequiredError}
     */
    getError(id: number, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<BridgeError>>;
    /**
     * Get the list of errors from the error catalog.
     * @summary Get the list of errors.
     * @param {number} [page]
     ...
     * @throws {RequiredError}
     */
    getErrors(page?: number | undefined, size?: number | undefined, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ErrorListResponse>>;
};
/**
 * ErrorCatalogApi - factory interface
 * @export
 */
export declare const ErrorCatalogApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Get an error from the error catalog.
     * @summary Get an error from the error catalog.
     * @param {number} id
     ...
     * @throws {RequiredError}
     */
    getErrors(page?: number | undefined, size?: number | undefined, options?: any): AxiosPromise<ErrorListResponse>;
};
/**
